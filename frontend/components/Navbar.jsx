...
const FACEBOOK_ICON_SVG = '<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 40 40" fill="none" data-wiggle-target="" aria-hidden="true"><path fill="currentColor" d="M24.75 9.75H27V5.875h-2.625c-4.064 0-6.625 2.759-6.625 6.969v2.656h-3.062v4h3.062V31h4.125V19.5h3.5l.688-4h-4.188v-2.313c0-1.5.875-2.25 2.375-2.25Z"/></svg>';
...
export default function Navbar() {
    useEffect(() => {
        ...
        const cleanups = [];
        const logoAtomic = document.querySelector('.logo-atomic');
        if (logoAtomic) cleanups.push(initWiggle(logoAtomic, WIGGLE_CONFIG.logoAtomic));
        ...
        <>
            ...
            <nav className="navbar">
                            ...
                            <div className="nav-popout-inner">
                                <div className="nav-work-item">
                                    <div className="nav-work-item__img-wrap">
                                        <img src="/img/shop.png" loading="eager" alt="Feestje bouwe? App Douwe" className="nav-work-item__img" />
                                    </div>
                                    <div className="nav-work-item__text">
                                        <span className="nav-work-badge badge-maroon">bạn cần giày dép?</span>
                                        <h4 className="nav-work-title">nhấn vào đây..:D</h4>
                                    </div>
                                </div>
                                <div className="nav-work-item">
                                    <div className="nav-work-item__img-wrap">
                                        <img src="/img/computer.png" loading="eager" alt="Skibidi school" sizes="100vw" srcSet="/img/computer.png 500w, /img/computer.png 1080w" className="nav-work-item__img" />
                                    </div>
                                    <div className="nav-work-item__text">
                                        <span className="nav-work-badge badge-pink">cần đồ công nghệ?</span>
                                        <h4 className="nav-work-title">tim tôi ngay...</h4>
                                    </div>
                                </div>
                                <div className="nav-work-item">
                                    <div className="nav-work-item__img-wrap">
                                        <img src="/img/book.png" loading="eager" alt="Hema socials" sizes="100vw" srcSet="/img/book.png 500w, /img/book.png 1080w" className="nav-work-item__img" />
                                    </div>
                                    <div className="nav-work-item__text">
                                        <span className="nav-work-badge badge-pink">đồ án làm bạn mệt</span>
                                        <h4 className="nav-work-title">biết ai giúp bạn rồi đó.</h4>
                                    </div>
                                </div>
                ...
                <div className="nav-center" style={{ cursor: "url('/assets/Cursor SVG/cursor-pointer.svg') 12 12, pointer" }}>
                    <div className="logo-atomic" aria-label="Atomic logo" />
                </div>
                    ...
                    <div className="nav-hover-trigger">
                        ...
                        <div className="nav-popout nav-wa-box">
                            <div className="nav-popout-inner">
                                ...
                                <h4 className="nav-wa-title">scan me</h4>
                                <p className="nav-wa-desc">Scan the QR code to chat with me via your smartphone.</p>
                                <a href="#" className="nav-wa-link">
                                    <span className="nav-wa-link-text"></span>
                                ...
                                <div className="nav-wa-socials">
                                    {SOCIAL_ICONS.map(({ href, label, svg }) => (
                                        <a
                                            ...
                                            aria-label={label}
                                            dangerouslySetInnerHTML={{ __html: label === 'Facebook' ? FACEBOOK_ICON_SVG : svg }}
                                        />
                                    ))}
                                </div>
                            </div>

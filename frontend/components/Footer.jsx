        ...
        <div className="footer-inner">
            <div className="footer-top">
                ...
                <div className="footer-column">
                    ...
                    <a href="mailto:truongvany1608@gmail.com" className="footer-email">truongvany1608@gmail.com</a>
                    <a href="#" className="footer-whatsapp">send me a message*</a>
                    <p className="footer-note">*m&apos;e and you for future reference.</p>
            ...
            <div className="footer-bottom">
                <div className="footer-big-text footer-big-logo">
                    <div className="footer-big-logo__graphic" aria-label="Atomic logo" role="img" />
                    <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 1368 304" fill="none" className="footer-logo__svg footer-logo__svg--legacy" aria-hidden="true">
                        ...
                        <div className="credits-box">
                            <div className="credits-content">
                                <div className="credits-item credit-wiggle">
                                    ...
                                    <div className="overflow-wrapper"><a href="#" className="credits-name" data-wiggle-target="true">Me</a></div>
                                </div>
                                <div className="credits-item credit-wiggle">
                                    <div className="overflow-wrapper"><span className="credits-label">code by</span></div>
                                    <div className="overflow-wrapper"><a href="#" className="credits-name" data-wiggle-target="true">Atomic</a></div>
                                </div>
                            </div>
                        </div>
                        <a href="#" className="footer-credits">atomic</a>
                    </div>
                </div>
            </div>
        </div>

...
export default function VimeoHero() {
    ...
    ──────────────────────────────────────────────────── */
    useEffect(() => {
        if (!canHover) return; // Skip mute bubble on touch devices
        ...
        return () => {
            ...
            hero.removeEventListener('mouseenter', onEnter); // eslint-disable-line
    ...
    return (
        <>
            {/* ④ Hover mute bubble — desktop only (follows cursor over the video) */}
            {canHover && (
                <div
                    ref={bubbleRef}
            ...
            >
                ...
                */}
                ...
                {/* Mobile mute button — touch only, shown via CSS */}
                <button
                    className="vimeo-mobile-mute"
                ...
                <div className="home-header__title">
                    <h1 className="vimeo-hero__title" ref={titleRef} onClick={(e) => e.stopPropagation()}>
                        ...
                        {/* "advertising" italic */}
                        <span className="vimeo-hero__word"><em>tác động lớn </em></span>
                        ...
                        <span className="vimeo-hero__word">atomic </span>

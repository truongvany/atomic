        ...
        <section
            ...
            <div className="motion-card__cards-area">
                ...
                <div ref={containerRef} className="motion-card__floating-labels">
                    <div className="motion-card__floating-label motion-card__floating-label--pink">
                        <p className="motion-card__floating-text">sáng tạo không giới hạn!</p>
                    </div>
                    <div className="motion-card__floating-label motion-card__floating-label--orange">
                        <p className="motion-card__floating-text">khác biệt là tiêu chuẩn...</p>
                    </div>
                    <div className="motion-card__floating-label motion-card__floating-label--red">
                        <p className="motion-card__floating-text">tư duy = giá trị cốt lõi</p>
                    </div>
                </div>
            </div>
            ...
            <div className="motion-card__footer-text">
                <p className="motion-card__description">
                    <b>
                        Atomic - Ý xây dựng giá trị
                        cho một thế hệ lướt nhanh nhưng luôn tìm kiếm sự chân thực.
                        Tôi biến những khái niệm trừu tượng thành giao diện sắc nét
                        và câu chuyện thương hiệu có chiều sâu.
                        Sáng tạo để khác biệt, thực thi để dẫn đầu.
                    </b>
                </p>
            </div>
        </section>
